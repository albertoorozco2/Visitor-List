...
public class Console {
	...
	public void mainMenu() {
		...
		System.out.println(" 2) Add a new candidate by position.");
		System.out.println(" 3) View List.");
		System.out.println(" 4) View candidate position by name.");
		System.out.println(" 5) View candidate position by ID.");
		System.out.println(" 6) Remove candidate by ID.");
		System.out.println(" 7) Remove candidate by position.");
		System.out.println(" 8) Cut off list");
		System.out.println(" 9 ) Update candidate details.\t");
		...
		case 1:
			...
			break;
		case 2:
			System.out.println("\n\n 2) Add a new candidate by position.");
			addPerson(true);
			break;
		case 3:
			System.out.println("\n\n 3) View List.");
			...
			break;
		case 4:
			System.out.println("\n\n 4) View candidate position by name.");
			...
			break;
		case 5:
			System.out.println("\n\n 5) View candidate position by ID.");
		...
		case 6:
			...
			break;
		case 7:
			System.out.println("\n\n 7) Remove candidate by position.");
		...
		case 8:
			System.out.println("\n\n 8) Cut off list");
			System.out.println("\n\nType number of candidates to remove from the back of the list, current size of list: " + LinkedList.size);
	...
	public void addPerson(boolean position) {
		...
		if(position==true) {
			...
			Candidate newCandidate = LinkedList.insertCandidate(candidateNumber, firstName, lastName, date, passport, kidLess3, kidLess1, positionList);
			System.out.println("\nYou have registered the following person:");
			newCandidate.showDetails();
			backMainMenu();	
		}
		
		Candidate newCandidate = LinkedList.insertCandidate(candidateNumber, firstName, lastName, date, passport, kidLess3, kidLess1);
		System.out.println("\nYou have registered the following person:");
		newCandidate.showDetails();
		backMainMenu();
	}
